...
class GalleryController extends Controller
{
    public function index(): void
    {
        ...
        $photos = [
            ['src' => 'https://images.unsplash.com/photo-1503951914875-452162b0f3f1?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80', 'alt' => 'Dali The Barber interieur', 'caption' => 'Onze Shop'],
            ...
            ['src' => 'https://images.unsplash.com/photo-1571902943223-12b96e5d2447?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80', 'alt' => 'Dali aan het werk', 'caption' => 'Vakwerk'],
        ...
        $this->render('gallery/index', [
            'page_title'       => 'Fotogalerij - Dali The Barber',
            'meta_description' => 'Bekijk de fotogalerij van Dali The Barber in Apeldoorn. Kapsels, baarden en de sfeer van onze barbershop.',
            'photos'           => $photos,
        ]);
    }
}
